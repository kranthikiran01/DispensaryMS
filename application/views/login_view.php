...
<body>
	...
	<div class="login-page">
		<div class="header-section">
			<a href="#"><img src="<?php echo base_url().'assets/images/logo_nitw.png'; ?> " alt="NITWarangal"><img src="<?php echo base_url().'assets/images/loginlogo.png'; ?>" alt=""></a>
			<ul class="menu">
		...
		<div class="form-section">
			...
			<div class="container">
				<div class="well form-inputs">
					...
					<h5><a href="<?php echo site_url('Forgot/index')?>" target="_blank">Forgot Your Password ?</a></h5>
				</div>				
			</div>
